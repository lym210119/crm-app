  ...
  <view class="focus-follow-page">
    <view class="filter-btn-group">
      <view
        ...
        >外拨状态 <text class="iconfont icon-arrow-right"></text
      ></view>
      <view
        class="status"
        :class="{ active: mask === 2 }"
        ...
        >
          <view class="item-right">
            <view class="item-right-top">
              <view>
                <text>任务名称 </text>
                <text class="cus-type">成功</text>
              </view>
              <view style="font-size: 24upx;">188****8888</view>
            </view>
            <view class="item-right-center">
              <view class="left" style="display: flex; flex-direction: column;font-size: 24upx;">
                <text>外拨日期：2020-03-05</text>
                <text>通话时长：19秒</text>
                <text>录音：<text class="iconfont icon-play"></text></text>

              </view>
              <view class="item-right-bottom">
                <button class="btn-success">抓取</button>
                <button class="btn-danger">丢公海</button>
              </view>
            </view>
          </view>
        </view>
