        ...
        <view class="item" v-for="item in listData" :key="item.id">
          <view class="item-right">
            ...
            <view class="item-right-center">
              <text>报销金额：5000（交通费）</text>
              <text>财务确认：未确认 <text class="btn-confirm">确认</text></text>
            </view>
            <view class="item-right-center">
              <text>收支人员：张三</text>
              <text>收支时间：2020-03-04</text>
            </view>
            <view class="item-right-center">
              <text>录入人员：李四</text>
              <text>状态：正常 <text class="btn-void">作废</text></text>
            </view>
            <view class="item-right-bottom">
              <text>备注：备注备注备注备注备注</text>
            </view>
          </view>
        </view>
