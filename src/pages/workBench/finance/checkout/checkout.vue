      ...
      >
        <view class="item" v-for="item in listData" :key="item.id">
          <view class="item-right">
            ...
            <view class="item-right-center">
              <text>签单时间：2020-03-04</text>
              <text>做单时间：2020-03-04</text>
            </view>
            <view class="item-right-bottom">
              <view class="btn-group">
                <button size="mini" class="btn-success">费用清单</button>
                <button size="mini" class="btn-primary">收费</button>
                <button size="mini" class="btn-info">内部凭证</button>
                <button size="mini" class="btn-danger">客户凭证</button>
                <button size="mini" class="btn-danger">结账</button>
              </view>
            </view>
