  ...
  <view class="focus-follow-page">
    <view class="filter-btn-group">
      <view
        ...
        >做单状态 <text class="iconfont icon-arrow-right"></text
      ></view>
      <view
        class="status"
        :class="{ active: mask === 2 }"
    ...
    <view class="list-container">
      ...
      >
          ...
          <view class="item-box" v-for="item in listData" :key="item.id">
          <view class="item" >
            ...
            <view class="item-right">
              ...
              <view class="item-right-center">
                <text>协议编号：DY110</text>
                <text>类型：2抵</text>
              </view>
              <view class="item-right-bottom">
                <text v-if="item.follow">贷款金额：100000</text>
                <text v-if="item.follow">状态：进行中</text>
              </view>
            </view>
          </view>
            <view class="item-bottom">
              <view>2020-03-03 / 签单日期</view>
              <view class="btn-group">
                <button class="btn-danger" size="mini">退件</button>
                <button class="btn-primary" size="mini">放款</button>
                <button class="btn-warning" size="mini">重分配</button>
                <button class="btn-success" size="mini">报销</button>
              </view>
            </view>
          </view>
